...
We also need to declare the cookie names for the  access and refresh tokens,
as we’ll be using both.
"""
REST_FRAMEWORK = {
...
# If I not set to None, the cookies would  be blocked.
JWT_AUTH_SAMESITE = 'None'

REST_AUTH_SERIALIZERS = {
    # overwrite the default USER_DETAILS_SERIALIZER
    # with the serializer we created in drf_api serializer.py
...
if 'CLIENT_ORIGIN' in os.environ:
    ...
    CORS_ALLOWED_ORIGIN_REGEXES = [
        # regular expression  to allow requests that are coming from Gitpod
        r"^https://.*\.gitpod\.io$",
    ]


# make it possible to send  cookies in cross-origin requests
